...
- Stockage de données en cache (Essai d'implementation dans la classe Controller mais ne marche pas car sans connexion L'API ne s'affiche pas. Il y a donc surement une erreur lors de la lecture ou de l'écriture en cache)
- Architecture MVC
